...
<div>
    <transition name="calendar"  mode="out-in">
        <div class="calendar" v-show="show" :style="{'left':x+'px','top':y+'px'}">
            <div >
                ...
                <tr v-for="(k1,day) in days">
                    ...
                    <span>{{k2}}</span>
                    <div class="lunar" v-show="showLunar">{{k2}}</div>
                    </td>
                </tr>
                </table>
            </div>
...
export default {
    ...
    // props:['show','type','value','x','y','begin','end','range','rangeBegin','rangeEnd','sep'],
    data() {
        return {
            year: 0,
            month: 0,
