    ...
    <div>
        ...
        <div class="user-task">
            <ul class="clear">
                <li class='new-task' @click="openNewTask">
                   <i></i>  
                   <span style="position:relative;">已收到的邀请({{user.inviteNum}})
                   <!-- <span class="task-msg" v-show="user.inviteNum">{{user.inviteNum}}</span> -->
                   </span>
        ...
        <div class="mint-msgbox" v-show="mintMsgbox==true">
            ...
            <div class="mint-msgbox-title">
               {{user.customerService.tel}}
            </div>
             <div class="mint-msgbox-content">
                <p>工作日 {{user.customerService.workDay}}</p>
                <p>节假日 {{user.customerService.festival}}</p>
            </div>
...
import BotNav from '../components/bot-nav.vue';
  ...
  Vue.component(DatetimePicker.name, DatetimePicker);
    export default{
        ...
        methods:{
            callSomeWhere(){
                window.location.href='tel:'+this.user.customerService.tel;
            },  
            jump(){
