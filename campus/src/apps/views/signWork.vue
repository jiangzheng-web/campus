        ...
        <div class="change-body">
        	...
        	<div>
        		...
        		<div style="position:relative">
        			<p style="width:100%;height:100%;position:absolute;z-index:502;" v-show="images[0]"></p>
        			...
        			<span class="delete" style="z-index:503;" v-show="images.length"  @click="deleImg(images[0])"></span>
        			<i></i>
        		</div>
        	</div>
        	</form>
